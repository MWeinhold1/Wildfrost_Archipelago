...
namespace Wildfrost_Archipelago.Constants
{
    ...
    public static class APLocationConstants
    {
        ...
        public static Dictionary<int, APLocation> LocationReferences = new Dictionary<int, APLocation>
        {
            ...
            {10004, new APLocation(10004, 1, "Companion 1", "Hot Spring: Tiny Tyko")},
            {10005, new APLocation(10005, 1, "Companion 2", "Hot Spring: Bombom")},
            {10006, new APLocation(10006, 1, "Companion 3", "Hot Spring: Nova")},
            {10007, new APLocation(10007, 1, "Companion 4","Hot Spring: Lupa")},
            {10008, new APLocation(10008, 1, "Companion 5","Hot Spring: The Baker")},
            {10009, new APLocation(10009, 1, "Companion 6","Hot Spring: Toaster")},
