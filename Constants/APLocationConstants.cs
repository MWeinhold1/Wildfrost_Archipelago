...
namespace Wildfrost_Archipelago.Constants
{
    ...
    public static class APLocationConstants
    {
        ...
        public static Dictionary<int, APLocation> LocationReferences = new Dictionary<int, APLocation>
        {
            ...
            // Gnome
            {30061, new APLocation(30061, 3, "", "Kill Naked Gnome")},
            {30062, new APLocation(30062, 3, "", "Kill ArchipelaGnome")},
            // Clunkers
            {30063, new APLocation(30063, 3, "", "Kill Bombarder")},
            {30064, new APLocation(30064, 3, "", "Kill Ice Forge")},
            {30065, new APLocation(30065, 3, "", "Kill Ice Lantern")},
            {30066, new APLocation(30066, 3, "", "Kill Mega Mimik")},
            {30067, new APLocation(30067, 3, "", "Kill Mimik")},
            {30068, new APLocation(30068, 3, "", "Kill Octobom")},
            {30069, new APLocation(30069, 3, "", "Kill Plinker")},
            {30070, new APLocation(30070, 3, "", "Kill Spike Wall")},
            // (Mini) Boss Kills
