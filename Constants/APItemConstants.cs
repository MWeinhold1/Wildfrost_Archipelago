...
namespace Wildfrost_Archipelago.Constants
{
    ...
    public static class APItemConstants
    {
        ...
        public static Dictionary<long, APItem> CommonItems = new Dictionary<long, APItem>
        {
            ...
            {50003, new APItem(50003, 50, "Demonheart", "Demonheart")},
            {50004, new APItem(50004, 50, "FrostBell", "Frost Bell")},
            {50005, new APItem(50005, 50, "FrostBloom", "Frostbloom")},
            {50006, new APItem(50006, 50, "Hooker", "Grabber")},
            {50007, new APItem(50007, 50, "IceDice", "Ice Dice")},
            {50008, new APItem(50008, 50, "MoltenDip", "Molten Dip")},
            {50009, new APItem(50009, 50, "NoomlinBiscuit", "Noomlin Biscuit")},
            {50010, new APItem(50010, 50, "PinkberryJuice", "Pinkberry Juice")},
            {50011, new APItem(50011, 50, "PomegranateBomb", "Pombomb")},
            {50012, new APItem(50012, 50, "Slapcrackers", "Slapcrackers")},
            {50013, new APItem(50013, 50, "Snowcake", "Snowcake")},
            {50014, new APItem(50014, 50, "SnowGlobe", "Storm Globe")},
            {50015, new APItem(50015, 50, "SunlightDrum", "Sunlight Drum")},
            {50016, new APItem(50016, 50, "ZoomlinWafers", "Zoomlin Wafers")},
            {50017, new APItem(50017, 50, "Bitebox", "Bitebox")},
            {50018, new APItem(50018, 50, "Blingo", "Bling Bank")},
            {50019, new APItem(50019, 50, "HeartmistStation", "Heartmist Station")},
            {50020, new APItem(50020, 50, "Krono", "Krono")},
            {50021, new APItem(50021, 50, "MegaMimik", "Mega Mimik")},
        ...
        public static Dictionary<long, APItem> SnowItems = new Dictionary<long, APItem>
        {
            ...
            {51006, new APItem(51006, 51, "ScrapPile", "Scrap Pile")},
            {51007, new APItem(51007, 51, "ShellShield", "Shell Shield")},
            {51008, new APItem(51008, 51, "Shellbo", "Shelbo")},
            {51009, new APItem(51009, 51, "SnowStick", "Snow Stick")},
            {51010, new APItem(51010, 51, "SpiceStones", "Spice Stones")},
            {51011, new APItem(51011, 51, "SporePack", "Spore Pack")},
            {51012, new APItem(51012, 51, "StormbearSpirit", "Stormbear Spirit")},
            {51013, new APItem(51013, 51, "SunRod", "Sun Rod")},
            {51014, new APItem(51014, 51, "ShroomLauncher", "Fungo Blaster")},
            {51015, new APItem(51015, 51, "Heartforge", "Heartforge")},
            {51016, new APItem(51016, 51, "Snowcracker", "Kobonker")},
            {51017, new APItem(51017, 51, "MobileCampfire", "Mobile Campfire")},
            {51018, new APItem(51018, 51, "Peppermaton", "Moko Totem")},
            {51019, new APItem(51019, 51, "PepperFlag", "Pepper Flag")},
            {51020, new APItem(51020, 51, "Shroominator", "Shroominator")},
            {51021, new APItem(51021, 51, "Shroomine", "Shroomine")},
            {51022, new APItem(51022, 51, "SpiceSparklers", "Spice Sparklers")},
            {51023, new APItem(51023, 51, "Woodhead", "Woodhead")},
        };
        ...
        public static Dictionary<long, APItem> ShadeItems = new Dictionary<long, APItem>
        {
            ...
            {52007, new APItem(52007, 52, "Bonescraper", "Bonescrapper")},
            {52008, new APItem(52008, 52, "FallowMask", "Fallow Mask")},
            {52009, new APItem(52009, 52, "JunjunMask", "Junjun Mask")},
            {52010, new APItem(52010, 52, "Leecher", "Leech Mask")},
            {52011, new APItem(52011, 52, "PigeonCage", "Pom Mask")},
            {52012, new APItem(52012, 52, "Putty", "Shade Clay")},
            {52013, new APItem(52013, 52, "EnemyCloner", "Shade Wisp")},
            {52014, new APItem(52014, 52, "PopPopper", "Sheepopper Mask")},
            {52015, new APItem(52015, 52, "SkullMuffin", "Skull Muffin")},
            {52016, new APItem(52016, 52, "Scythe", "Skullmist Tea")},
            {52017, new APItem(52017, 52, "SnufferMask", "Snuffer Mask")},
            {52018, new APItem(52018, 52, "VoidStaff", "Soulbound Skulls")},
            {52019, new APItem(52019, 52, "SunburstDart", "Sunburst Tootoo")},
            {52020, new APItem(52020, 52, "SharkTooth", "Tiger Skull")},
            {52021, new APItem(52021, 52, "TigrisMask", "Tigris Mask")},
            {52022, new APItem(52022, 52, "SnowMaul", "Yeti Skull")},
        };
        ...
        public static Dictionary<long, APItem> CommonUnits = new Dictionary<long, APItem>
        {
            ...
            {60002, new APItem(60002, 60, "Bombom", "Bombom")},
            {60003, new APItem(60003, 60, "Bonnie", "Bonnie")},
            {60004, new APItem(60004, 60, "Dimona", "Dimona")},
            {60005, new APItem(60005, 60, "Foxee", "Foxee")},
            {60006, new APItem(60006, 60, "Noggin", "Gojiber")},
            {60007, new APItem(60007, 60, "Klutz", "Jumbo")},
            {60008, new APItem(60008, 60, "LuminCat", "Lupa")},
            {60009, new APItem(60009, 60, "NakedGnome", "Naked Gnome")},
            {60010, new APItem(60010, 60, "Blue", "Nova")},
            {60011, new APItem(60011, 60, "MagmaBlacksmith", "Roibos")},
            {60012, new APItem(60012, 60, "Snobble", "Snobble")},
            {60013, new APItem(60013, 60, "Snoffel", "Snoffel")},
        };
        ...
        public static Dictionary<long, APItem> SnowUnits = new Dictionary<long, APItem>
        {
            ...
            {61010, new APItem(61010, 61, "TinyTyko", "Tiny Tyko")},
            {61011, new APItem(61011, 61, "Wallop", "Wallop")},
            {61012, new APItem(61012, 61, "Wort", "Wort")},
            {61013, new APItem(61013, 61, "Yuki", "Yuki")},
        };
        ...
        public static Dictionary<long, APItem> ShadeUnits = new Dictionary<long, APItem>
        {
            ...
            {62010, new APItem(62010, 62, "TheBaker", "The Baker")},
            {62011, new APItem(62011, 62, "Tusk", "Tusk")},
            {62012, new APItem(62012, 62, "BoBo", "Van Jun")},
            {62013, new APItem(62013, 62, "Flash", "Vesta")},
            {62014, new APItem(62014, 62, "Zula", "Zula")},
        };
        ...
        public static Dictionary<long, APItem> ClunkUnits = new Dictionary<long, APItem>
        {
            ...
            {63013, new APItem(63013, 63, "Havok", "Toaster")},
        };
        ...
        public static Dictionary<long, APItem> Bell = new Dictionary<long, APItem>
        {
            ...
            // Storm Bells
            {80011, new APItem(80011, 80, "ExpensiveShops", "Blingsnail Bell")},
            {80012, new APItem(80012, 80, "CompanionInjuries", "Bell of Death")},
            {80013, new APItem(80013, 80, "BossesHaveCharms", "Titan Bell")},
            {80014, new APItem(80014, 80, "ReduceBossWaveCounter", "Frosthand Bell")},
            {80015, new APItem(80015, 80, "DeadweightAfterBosses", "Gunk Bell")},
            {80016, new APItem(80016, 80, "IceCavesEnemiesIncreaseAttack", "Icebourne Bell")},
            {80017, new APItem(80017, 80, "EarlyMinibosses", "Horde Bell")},
            {80018, new APItem(80018, 80, "CardsStartWithNegativeCharms", "Gloom Bell")},
            {80019, new APItem(80019, 80, "FrostlandEnemiesIncreaseAttack", "Frostbourne Bell")},
            {80020, new APItem(80020, 80, "Sunbringer", "Gobbler Bell")},
            {80021, new APItem(80021, 80, "CursedCrowns", "Tyrant Bell")},
            {80022, new APItem(80022, 80, "EnemyCharms", "Dread Bell")},
            {80023, new APItem(80023, 80, "DrainLeader", "Blood Bell")},
            // Daily Voyage Bells
            {80024, new APItem(80024, 80, "BoostEnemyDamage", "Battle Bell")},
            {80025, new APItem(80025, 80, "DoubleBlingsFromGoblings", "Blingsack Bell")},
            {80026, new APItem(80026, 80, "BombskullClunkers", "Bombskull Bell")},
            {80027, new APItem(80027, 80, "DrawMoreCardsWhenRedrawNotCharged", "Broken Bell")},
            {80028, new APItem(80028, 80, "AimlessStartingItems", "Fog Bell")},
            {80029, new APItem(80029, 80, "FrenzyBosses", "Frenzy Bell")},
            {80030, new APItem(80030, 80, "BlockForMinibosses", "Frozen Heart Bell")},
            {80031, new APItem(80031, 80, "DemonizeEnemies", "Goat Bell")},
            {80032, new APItem(80032, 80, "DoubleBlingsFromCombos", "Gold Blade Bell")},
            {80033, new APItem(80033, 80, "BoostEveryonesHealth", "Heart Bell")},
            {80034, new APItem(80034, 80, "BoostAllEffects", "Lumin Bell")},
            {80035, new APItem(80035, 80, "NoCompanionLimit", "Party Bell")},
        };
