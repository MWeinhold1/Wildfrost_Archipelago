...
namespace Wildfrost_Archipelago.Constants
{
    ...
    public static class APItemConstants
    {
        ...
        public static Dictionary<long, APItem> CommonItems = new Dictionary<long, APItem>
        {
            ...
            {50006, new APItem(50006, 50, "IceDice", "Ice Dice")},
            {50007, new APItem(50007, 50, "MoltenDip", "Molten Dip")},
            {50008, new APItem(50008, 50, "NoomlinBiscuit", "Noomlin Biscuit")},
            {50009, new APItem(50009, 50, "PinkberryJuice", "Pinkberry Juice")},
            {50010, new APItem(50010, 50, "PomegranateBomb", "Pombomb")},
            {50011, new APItem(50011, 50, "Snowcake", "Snowcake")},
            {50012, new APItem(50012, 50, "SnowGlobe", "Storm Globe")},
            {50013, new APItem(50013, 50, "SunlightDrum", "Sunlight Drum")},
            {50014, new APItem(50014, 50, "ZoomlinWafers", "Zoomlin Wafers")},
            {50015, new APItem(50015, 50, "Bitebox", "Bitebox")},
            {50016, new APItem(50016, 50, "Blingo", "Bling Bank")},
            {50017, new APItem(50017, 50, "HeartmistStation", "Heartmist Station")},
            {50018, new APItem(50018, 50, "Mimik", "Mimik")},
            {50019, new APItem(50019, 50, "TotemOfTheGoat", "Totem of the Goat")},
            {50020, new APItem(50020, 50, "ZoomlinNest", "Zoomlin Nest")},
            {50021, new APItem(50021, 50, "BrokenVase", "Broken Vase")},
            {50022, new APItem(50022, 50, "LuminSealant", "Lumin Goop")},
            {50023, new APItem(50023, 50, "LuminVase", "The Lumin Vase")},
        };
        ...
        public static Dictionary<long, APItem> CommonUnits = new Dictionary<long, APItem>
        {
            ...
            {60008, new APItem(60008, 60, "Blue", "Nova")},
            {60009, new APItem(60009, 60, "MagmaBlacksmith", "Roibos")},
            {60010, new APItem(60010, 60, "Snobble", "Snobble")},
            {60011, new APItem(60011, 60, "Snoffel", "Snoffel")},
        };
