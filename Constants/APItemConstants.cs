...
namespace Wildfrost_Archipelago.Constants
{
    ...
    public static class APItemConstants
    {
        ...
        public static Dictionary<long, APItem> CommonItems = new Dictionary<long, APItem>
        {
            ...
            {50003, new APItem(50003, 50, "Shwooper", "Blizzard Bottle")},
            {50004, new APItem(50004, 50, "Demonheart", "Demonheart")},
            {50005, new APItem(50005, 50, "FrostBell", "Frost Bell")},
            {50006, new APItem(50006, 50, "FrostBloom", "Frostbloom")},
            ...
            {50012, new APItem(50012, 50, "Snowcake", "Snowcake")},
            {50013, new APItem(50013, 50, "SnowGlobe", "Storm Globe")},
            {50014, new APItem(50014, 50, "SunlightDrum", "Sunlight Drum")},
            {50015, new APItem(50015, 50, "ZoomlinWafers", "Zoomlin Wafers")},
            {50016, new APItem(50016, 50, "Bitebox", "Bitebox")},
            {50017, new APItem(50017, 50, "Blingo", "Bling Bank")},
            {50018, new APItem(50018, 50, "HeartmistStation", "Heartmist Station")},
            {50019, new APItem(50019, 50, "Mimik", "Mimik")},
            {50020, new APItem(50020, 50, "TotemOfTheGoat", "Totem of the Goat")},
            {50021, new APItem(50021, 50, "ZoomlinNest", "Zoomlin Nest")},
            {50022, new APItem(50022, 50, "BrokenVase", "Broken Vase")},
            {50023, new APItem(50023, 50, "LuminSealant", "Lumin Goop")},
            {50024, new APItem(50024, 50, "LuminVase", "The Lumin Vase")},
        };
        ...
        public static Dictionary<long, APItem> ShadeItems = new Dictionary<long, APItem>
        {
            ...
            {52006, new APItem(52006, 52, "Bonescraper", "Bonescrapper")},
            {52007, new APItem(52007, 52, "FallowMask", "Fallow Mask")},
            {52008, new APItem(52008, 52, "JunjunMask", "Junjun Mask")},
            {52009, new APItem(52009, 52, "Leecher", "Leech Mask")},
            {52010, new APItem(52010, 52, "PigeonCage", "Pom Mask")},
            {52011, new APItem(52011, 52, "Putty", "Shade Clay")},
            {52012, new APItem(52012, 52, "EnemyCloner", "Shade Wisp")},
            {52013, new APItem(52013, 52, "PopPopper", "Sheepopper Mask")},
            {52014, new APItem(52014, 52, "SkullMuffin", "Skull Muffin")},
            {52015, new APItem(52015, 52, "Scythe", "Skullmist Tea")},
            {52016, new APItem(52016, 52, "SnufferMask", "Snuffer Mask")},
            {52017, new APItem(52017, 52, "VoidStaff", "Soulbound Skulls")},
            {52018, new APItem(52018, 52, "SunburstDart", "Sunburst Tootoo")},
            {52019, new APItem(52019, 52, "SharkTooth", "Tiger Skull")},
            {52020, new APItem(52020, 52, "TigrisMask", "Tigris Mask")},
            {52021, new APItem(52021, 52, "SnowMaul", "Yeti Skull")},
        };
        ...
        public static Dictionary<long, APItem> CommonUnits = new Dictionary<long, APItem>
        {
            ...
            {60008, new APItem(60008, 60, "MagmaBlacksmith", "Roibos")},
            {60009, new APItem(60009, 60, "Snobble", "Snobble")},
            {60010, new APItem(60010, 60, "Snoffel", "Snoffel")},
        };
